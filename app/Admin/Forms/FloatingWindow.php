...
class FloatingWindow extends Form
{
    ...
    public function handle(Request $request)
    {
        ...
        SiteBaseSettingModel::updateOrCreate([
            ...
            'floating_window' => $data
        ]);

        admin_success('飘窗设置成功');
    ...
    public function form()
    {
        ...
        $this->switch('enabled', '启用飘窗')->states(static::SWITCH_STATES);
    ...
    public function data()
    {
        ...
        if ($settings) {
            return $settings['floating_window'] ?? $defaults;
        }

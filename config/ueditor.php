...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/uploads/images/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/uploads/images/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/uploads/images/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/uploads/images/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/uploads/videos/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'filePathFormat' => '/uploads/files/{yyyy}/{mm}/{dd}/{time}-{filename}', /* 上传保存路径,可以自定义保存路径和文件名格式 */
